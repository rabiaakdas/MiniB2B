        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Banners_DateRange", "[EndDate] IS NULL OR [StartDate] IS NULL OR [EndDate] >= [StartDate]");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    RenderType = table.Column<int>(type: "int", nullable: false),
                    Width = table.Column<int>(type: "int", nullable: true),
                    Alignment = table.Column<int>(type: "int", nullable: false),
                    IsVisibleDesktop = table.Column<bool>(type: "bit", nullable: false),
                    IsVisibleTablet = table.Column<bool>(type: "bit", nullable: false),
                    IsVisibleMobile = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductGridColumns", x => x.Id);
                    table.CheckConstraint("CK_ProductGridColumns_Width_PositiveOrNull", "[Width] IS NULL OR [Width] > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialCode1 = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SpecialCode2 = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_CriticalStockLevel_NonNegative", "[CriticalStockLevel] >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderItems_TotalPrice_NonNegative", "[TotalPrice] >= 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductGridColumns_IsActive_DisplayOrder",
                table: "ProductGridColumns",
                columns: new[] { "IsActive", "DisplayOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ManufacturerCode",
                table: "Products",
